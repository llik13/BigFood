...
namespace Registration.Migrations
{
    ...
    [Migration("20241128192247_deliver3")]
    partial class deliver3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Registration.Models.DeliverModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Registration.Models.DeliverModel", b =>
                {
                    b.OwnsMany("JWTAuthentication.WebApi.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<string>("DeliverModelId")
                                .HasColumnType("varchar(255)");
                            ...
                            b1.HasKey("DeliverModelId", "Id");

                            b1.ToTable("Deliverers_RefreshTokens");

                            b1.WithOwner()
                                .HasForeignKey("DeliverModelId");
                        });
