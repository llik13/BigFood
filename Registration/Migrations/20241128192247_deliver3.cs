...
{
    /// <inheritdoc />
    public partial class deliver3 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Deliverers_RefreshTokens",
                columns: table => new
                {
                    DeliverModelId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Token = table.Column<string>(type: "longtext", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deliverers_RefreshTokens", x => new { x.DeliverModelId, x.Id });
                    table.ForeignKey(
                        name: "FK_Deliverers_RefreshTokens_Deliverers_DeliverModelId",
                        column: x => x.DeliverModelId,
